CREATE DATABASE  IF NOT EXISTS `interview_test` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `interview_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
-- Host: localhost    Database: interview_test
-- ------------------------------------------------------
...
CREATE TABLE `answers` (
  ...
  `correctness` char(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `uid_idx` (`uid`),
  KEY `qid_idx` (`qid`),
  KEY `uid_fk_idx` (`uid`),
  KEY `qid_fk_idx` (`qid`),
  CONSTRAINT `qid_fk` FOREIGN KEY (`qid`) REFERENCES `questions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
